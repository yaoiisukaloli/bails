...
exports.getStatusCodeForMediaRetry = exports.decryptMediaRetryData = exports.decodeMediaRetryNode = exports.encryptMediaRetryRequest = exports.getWAUploadToServer = exports.downloadEncryptedContent = exports.downloadContentFromMessage = exports.getUrlFromDirectPath = exports.encryptedStream = exports.prepareStream = exports.getHttpStream = exports.getStream = exports.toBuffer = exports.audioToBuffer = exports.toReadable = exports.mediaMessageSHA256B64 = exports.generateProfilePicture = exports.encodeBase64EncodedStringForUpload = exports.extractImageThumb = exports.extractVideoThumb = exports.hkdfInfoKey = void 0;
...
async function getAudioDuration(buffer) {
    ...
    try {
        ...
        return (_a = metadata.format.duration) !== null && _a !== void 0 ? _a : 0;
    }
    catch (err) {
...
/**
  referenced from and modifying by RexxHayanasi
 */
...
const audioToBuffer = async (audio) => {
    ...
    return (0, exports.toBuffer)(audio);
};
